    ...
    >
      ...
      >
        ...
        <div class="hidden lg:flex lg:flex-auto lg:justify-end lg:items-center">
          <div v-if="!isLogin"
               style="width: 141px; height: 39px;  background: #000; border-radius: 7px; justify-content: center; align-items: center; gap: 8px; display: inline-flex">
            <div
                style="color: white; font-size: 14px;cursor:pointer; font-weight: normal; font-weight: 500; line-height: 20px; word-wrap: break-word">
      ...
      >
        <div class="contact-us">
          ...
          <div class="contact-us-btn cursor-pointer" @click="closeCOntact">
            <div>Send</div>
          ...
          <div style="position: relative;height: 100%;display: flex; flex-direction: column;">
                ...
                <div>
                  <template v-for="(item, index) in navList" :key="index">
                    <nuxt-link
                        ...
                        style="cursor: pointer;font-family: Archivo"
                    >{{ item.label }}
            ...
            <div style="display: flex; justify-content: center;margin:2.2vh 0;">
              <div @click="login2" v-if="!isLogin"
                ...
                <p
                    style="color: #050505; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word;margin-right:10px;">
                  Sign up/Login
                </p>
      ...
      >
        <template #header="{ close, titleId, titleClass }">
          <div style="text-align: center;position:relative;">
            <div style="font-size:20px; font-family: Archivo;color:#050505;">Recharge Record</div>
            <img @click="close" width="24" height="24" style="position:absolute;top:3px;right:0;" :src="closeimg"
                 alt="closeimg">
          </div>
        </template>
        <div class="Rechargeinfo-box">
          <div style="background-color: #F4F4F5;border-radius: 8px;" v-if="true" v-for="i in 9">
            <div class="flex flex-col py-2.5 px-6 my-2">
              <div class="my-0.5" style="font-family: Archivo;font-size:16px;font-weight: 600;">Recharge 300 Coins
                paying
                100 Rs
              </div>
              <div class="my-1" style="font-family: Archivo;font-size: 14px;">12:00:00 04/08/2024</div>
            </div>
          </div>
          <div v-else>
            <img style="margin:100px auto 12px auto;" width="70" height="70" :src="nodata" alt="nodata">
            <p style="font-family: Archivo;font-weight: 400;font-size: 12px;color: #050505;line-height: 14px;text-align: center;font-style: normal;text-transform: none;">
              There is no content here yet.</p>
          </div>
        </div>
      </el-drawer>
      <!--      登录弹窗-->
            ...
            <div class="flex flex-col gap-8">
                ...
                >
                  <template #prepend>
                    <div style="display: flex;text-align: center;align-items: center;">
                      ...
                      <div
                          style="color: black; font-size: 16px;  font-family: Archivo; font-weight: 500; line-height: 24px; word-wrap: break-word">
                        +91
                      </div>
                    </div>
                  </template>
                  <template #append>
                    <div>
                      <div style=" font-family: Archivo;cursor:pointer;color:#09090B;" @click="reSendMsg"
                           v-if="!sms.disabled">
                        Get OTP
                      </div>
                      <div style=" font-family: Archivo;color:gray;" v-else>
                        Get OTP ({{ sms.count }})
                      </div>
                    </div>
              ...
              <div class="input-border">
                <el-input
                    ...
                    class="input-with-select"
                    style=" font-family: Archivo; width: 420px;height: 62px;border: 0;font-size: 16px;"
                ></el-input>
              </div>
              <div @click="sendSmsLogin"
                ...
                <p style="font-family: Archivo;font-size:16px;">Sign in</p>
                <img width="15" height="15" :src="rightJ" alt="">
              </div>
            </div>
      ...
      <el-drawer
        ...
        <div>
          ...
          <div class="pt-12">
            <img style=" height: 72vw;margin:0 auto;" :src="boxone" alt="boxone">
          </div>
          ...
          <div class="mt-8 flex justify-between align-items-center"
            ...
            <div>
              <el-input
                  ...
                  inputmode="numeric"
                  @input="handleInput"
                  style=" font-family: Archivo;height: 14vw;border: 0"
              >
                <template #append>
                  <div>
                    <div style=" font-family: Archivo;cursor:pointer;color:#09090B;" @click="reSendMsg"
          ...
          <div class="mt-3 flex justify-between align-items-center"
               style="height: 14vw;border-radius: var(--Radius-8, 8px);background: var(--Color-surface-, #F4F4F5);">
            <div class="mx-2">
              ...
              <el-input
                  ...
                  inputmode="numeric"
                  @input="handleInput"
                  style="height: 14vw;;border: 0; font-family: Archivo;"
              >
              </el-input>
            </div>
          </div>
          <div class="flex justify-start items-center mt-10">
            ...
            <p style="color: var(--color-text-icon-color-3, #71717A);/* text-sm/normal */font-family: var(--font, Archivo);font-size: 12px;font-style: normal;font-weight: 400;line-height: 20px; /* 142.857% */">
              I authorize AwazMingle to contactme via email or phone or SMS. Any doubts, you can
              Check Terms & Conditions.</p>
          </div>
          <div class="my-28" @click="sendSmsLogin"
            ...
            <img width="20" height="20" :src="rightJ" alt="rightJ">
          </div>
          <!--          <div-->
      ...
      >
        <div class="Recharge-box">
          ...
          <div class="flex flex-col items-center w-11/12 h-4/6" style="overflow-y:scroll;scrollbar-width: none;">
            <div class="flex flex-col items-left w-3/4 p-4 m-2" v-for="i in 6"
                 style="border-radius:10px;background: #F4F4F5;">
              <div
                  style="color: var(--color-text-icon-color-1, #09090B);/* text-base/semibold */font-family: Archivo;font-size: 16px;font-style: normal;font-weight: 600;line-height: 24px; /* 150% */">
                Recharge 300 Coins paying 100 Rs
              </div>
              <div
                  style="color: var(--color-text-icon-color-3, #71717A);/* text-sm/normal */font-family:Archivo;font-size: 14px;font-style: normal;font-weight: 400;line-height: 20px; /* 142.857% */">
                12:00:00 04/08/2024
              </div>
            </div>
          </div>
...
const RechargshowClose = ref(true);
...
const Rechargeinfoopen = () => RechargeVisible.value = !RechargeVisible.value
const openContactUs = () => ContactDialogVisible.value = !ContactDialogVisible.value
...
const sendSms2 = async (type: number) => {
  ...
  if (!isArgee.value) {
    ElMessage.error("Authorize agree AwazMingle & associated ");
    return
  }
  //发送验证码
