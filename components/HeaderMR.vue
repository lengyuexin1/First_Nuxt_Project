        ...
        <div class="flex justify-start mr-14">
          ...
          >
            <div class="hidden lg:flex h-full">
              ...
              />
              <div style="color: #09090B; font-size: 15.90px; font-family: Figtree; font-weight: 700; line-height: 16px; word-wrap: break-word;margin-left: 25px;">ClickVoice</div>
            </div>
            <div class="lg:hidden h-full flex" v-if="!isLiveDetail">
              ...
              <img
                ...
                :style="{ '--delay': '-' + scrollTop + 's' }"
              />
              <div class="lg:hidden md" style="margin-left:30px;color: #09090B; font-size: 14.67px; font-family: Figtree; font-weight: 700; line-height: 20.96px; word-wrap: break-word">ClickVoice</div>
<!--              <div style="color: #09090B; font-size: 15.90px; font-family: Figtree; font-weight: 700; line-height: 22.71px; word-wrap: break-word;margin-left: 25px;">ClickVoice</div>-->
        ...
        <PopoverGroup class="hidden lg:flex lg:flex-2 lg:gap-x-10" style="margin-left:30% ;">
        ...
        <div class="hidden lg:flex lg:flex-auto lg:justify-end lg:items-center">
          <div v-if="!isLogin" style="width: 141px; height: 39px;  background: #F43F5E; border-radius: 12px; justify-content: center; align-items: center; gap: 8px; display: inline-flex">
            <div style="color: white; font-size: 14px; font-weight: normal; font-weight: 500; line-height: 20px; word-wrap: break-word"><button @click="login">Sign up/Login</button></div>
          </div>

          <span v-if="isLogin">
            <nuxt-link to="/recharge.html" >
              <div style=" padding-top: 2px; padding-bottom: 2px; padding-right: 24px; border-radius: 42px; justify-content: flex-start; align-items: center; gap: 6px; display: inline-flex">
                <div style="justify-content: flex-start; align-items: center; gap: 2px; display: flex">

                    <div style="width: 26px; height: 26px; padding: 1.08px; justify-content: center; align-items: center; display: flex">
                ...
                <div style="justify-content: flex-start; align-items: center; display: flex">
                  <div style="color: #71717A; font-size: 14px; font-weight: normal; font-weight: 500; word-wrap: break-word">Recharge</div>
            ...
            <ElDropdown  trigger="click">
              <div style="width: 100%; height: 100%; padding-left: 24px; justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
                <img v-if="!isLogin" style="width: 26px; height: 26px; border-radius: 9999px" :src="Logo" />
                <img v-if="isLogin" style="width: 26px; height: 26px; border-radius: 9999px" :src="userInfo.userInfo.headImg" />
              ...
              <template #dropdown>
                <ElDropdownMenu>
                  <ElDropdownItem>
                    <div style="width: 100%; height: 100%; padding: 16px; border-bottom: 1px #F4F4F5 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
                      <img style="width: 32px; height: 32px; border-radius: 9999px" :src="userInfo.userInfo.headImg" />
                      <div style="color: black; font-size: 14px; font-weight: normal; font-weight: 500; line-height: 20px; word-wrap: break-word">{{userInfo.userInfo.nickname}}</div>
                    </div>
                  </ElDropdownItem>
                  <ElDropdownItem @click="loginOut">
                    <div style="color: black;font-size: 14px;font-weight: normal;font-weight: 500;line-height: 20px;" @click="loginOut">Log out</div>
                  </ElDropdownItem>
                </ElDropdownMenu>
              </template>
            </ElDropdown>
        ...
        >
          <div style="position: relative;height: 100%;display: flex; flex-direction: column;">
                    ...
                    >
                      ...
                      <span v-if="!openMoreMenuActive" style="float: right;padding-top: 10px;">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.96875 4.16699L14.5313 10.0003L7.96875 15.8337" stroke="#28282F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                      </span>
                      <span v-if="openMoreMenuActive" style="float: right;padding-top: 10px;">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.8333 12.0312L9.99992 5.46875L4.16659 12.0313" stroke="#28282F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                      </span>
                    </div>
            ...
            <div style="display: flex; justify-content: center;">
              <div v-if="!isLogin" style="width: 70%;bottom: 0;position: sticky; display: grid;justify-content: center; padding-left: 15px; padding-right: 15px; padding-top: 15px; padding-bottom: 15px; border-radius: 12px; border: 1px #F43F5E solid; justify-content: center; align-items: center; display: inline-flex">
                <button  @click="login2"><div style="color: #F43F5E; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word">Sign up/Login</div></button>
              </div>
              <div v-if="isLogin"  style=" bottom: 0; position: sticky; width: 90%;height: 5rem; background: #FAFAFA; border-radius: 0.75rem; flex-direction: column; justify-content: center; align-items: flex-start; gap: 0.625rem; display: inline-flex">
                <!-- 最左边的 div -->
                <div style="justify-content: flex-start;margin-left: 4%; align-items: center; gap: 0.625rem; display: inline-flex">
                  <div style="border-radius: 0.5rem; justify-content: center; align-items: center; display: flex">
                    <img style="width: 2.75rem; height: 2.75rem; position: relative; border-radius: 6.875rem" :src="userInfo.userInfo.headImg" />
                  </div>
                  <div style="flex-direction: column; justify-content: center; align-items: flex-start; gap: 0.25rem; display: inline-flex">
                    <div style="color: #09090B; font-size: 0.875rem; font-weight: normal; font-weight: 500; line-height: 1.25rem; word-wrap: break-word">{{userInfo.userInfo.nickname}}</div>
                    <div style="color: #09090B; font-size: 0.75rem; font-weight: normal; font-weight: 400; line-height: 1rem; word-wrap: break-word">{{userInfo.userInfo.mobile}}</div>
                  </div>
                </div>

                <!-- 最右边的 div -->
                <div @click="loginOut" style="position: absolute; right: 1rem; top: 1.25rem; justify-content: center; align-items: center; display: inline-flex">
                  <div style="width: 1.5rem; height: 1.5rem; padding-top: 0.17375rem; padding-bottom: 0.170625rem; padding-left: 0.235625rem; padding-right: 0.203125rem; justify-content: center; align-items: center; display: inline-flex">
                    <div style="width: 1.06125rem; height: 1.15625rem; position: relative">
                      <svg width="19" height="21" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.8125 10.0225H0.771484" stroke="#09090B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.88477 7.10645L12.8128 10.0224L9.88477 12.9384" stroke="#09090B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M5.50439 5.38946V4.45646C5.50439 2.42146 7.15339 0.772461 9.18939 0.772461H14.0734C16.1034 0.772461 17.7484 2.41746 17.7484 4.44746V15.5875C17.7484 17.6225 16.0984 19.2725 14.0634 19.2725H9.17839C7.14939 19.2725 5.50439 17.6265 5.50439 15.5975V14.6555" stroke="#09090B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
      ...
      <el-dialog
          ...
          append-to-body
      >
        <div style="width: 100%; height: 100%; padding-left: 90px; padding-right: 90px; padding-top: 32px; padding-bottom: 32px; background: white; border-radius: 12px; flex-direction: column; justify-content: flex-start; align-items: center; gap: 48px; display: inline-flex">
          <div style="width: 143.59px; height: 50px; padding-top: 6.83px; padding-bottom: 7.27px; padding-right: 0.83px; justify-content: center; align-items: flex-end; gap: 5.82px; display: inline-flex">
            ...
            <div style="color: #09090B; font-size: 20.38px; font-family: Figtree; font-weight: 700; line-height: 35.9px; word-wrap: break-word">ClickVoice</div>
          </div>
          <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: flex">
            ...
            <button @click="sendSms2(2)">
              <div style="width: 420px; padding-top: 15px; padding-bottom: 15px; background: #F43F5E; border-radius: 7px; justify-content: center; align-items: center; display: inline-flex">
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word">Send OTP</div>
              </div>
            </button>
            <div style="width: 420px; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex">
              ...
              <div style="width: 386px; color: #71717A; font-size: 14px; font-weight: normal; font-weight: 500; line-height: 20px; word-wrap: break-word"><span></span>I authorize Teller.zone & associated astrologers to contactme via email or phone or SMS.<br/>Any doubts, you can Check Terms & Conditions.</div>
            </div>
          </div>
        </div>
      </el-dialog>
      <el-dialog
          ...
          append-to-body
      >
        <div style="width: 100%; height: 100%; padding-top: 32px; padding-bottom: 32px; background: white; border-radius: 12px; flex-direction: column; justify-content: space-between; align-items: center; display: inline-flex">
          <div style="align-self: stretch; padding-left: 16px; padding-right: 78px; justify-content: space-between; align-items: flex-start; display: inline-flex">
...
<!--              <div style="width: 16px; height: 8px; left: 12px; top: 24px; position: absolute; transform: rotate(-90deg); transform-origin: 0 0; border: 2.50px #475467 solid"></div>-->
            ...
            <div style="flex-direction: column; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
              <div style="width: 405px; text-align: center; color: #09090B; font-size: 20px; font-weight: normal; font-weight: 600; line-height: 28px; word-wrap: break-word">Enter the verification code</div>
              <div style="width: 405px; text-align: center; color: #71717A; font-size: 16px; font-weight: normal; font-weight: 400; line-height: 24px; word-wrap: break-word">Please enter the OTP sent to +91{{phoneNume}}</div>
            </div>
...
<!--            </div>-->
          ...
          <div style="flex-direction: column; justify-content: flex-start; align-items: center; gap: 12px; display: flex;margin-top: 52px;">
            <div class="digit-input-div" style="width: 444.55px; border-radius: 21.82px; justify-content: center; align-items: center; gap: 8.18px; display: inline-flex">
              <input  v-for="(digit, index) in digits" :key="index" @keydown="onKeyDown(index, $event)" inputmode="numeric" pattern="[0-9]*" v-model="digits[index]" @input="onDigitInput(index)" maxlength="1" class="digit-input" />
            </div>
            <div style="width: 405px; text-align: center"><span style="color: #71717A; font-size: 16px; font-weight: normal; font-weight: 400; line-height: 24px; word-wrap: break-word">Haven't received your code? </span><span @click="reSendMsg" style="cursor: pointer; color: #F43F5E; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word">Resend OTP</span></div>
          </div>
          <div style="cursor: pointer; width: 420px; padding-top: 15px; padding-bottom: 15px; background: #F43F5E; border-radius: 7px; justify-content: center; align-items: center; display: inline-flex;margin-top: 52px;">
            <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word" @click="sendSmsLogin">Verify</div>
          </div>
        </div>
      </el-dialog>
      <el-drawer
        ...
        <div>
          <div style="width: 100%; height: 100%; padding-top: 6.83px; padding-bottom: 7.27px; padding-right: 0.83px; justify-content: center; align-items: flex-end; gap: 5.82px; display: inline-flex">
            <div style="width: 34.94px; height: 35.90px; position: relative">
              <img style="width: 2.18rem; height: 2.243rem; left: 0; top: 0; position: absolute" :src="Logo" />              <div style="width: 2.35px; height: 9.36px; left: 5.48px; top: 10.59px; position: absolute; background: white; border-radius: 20.43px"></div>
              <div style="width: 2.35px; height: 5.96px; left: 9.74px; top: 12.29px; position: absolute; background: white; border-radius: 20.43px"></div>
              <div style="width: 2.35px; height: 20.10px; left: 14.10px; top: 5.22px; position: absolute; background: white; border-radius: 20.43px"></div>
              <div style="width: 2.35px; height: 10.18px; left: 18.27px; top: 10.18px; position: absolute; background: white; border-radius: 20.43px"></div>
              <div style="width: 2.35px; height: 5.96px; left: 22.51px; top: 12.29px; position: absolute; background: white; border-radius: 20.43px"></div>
          ...
          <div style="width: 100%;  margin-top: 20px;  background: #F4F4F5; border-radius: 7px; justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex">
            <el-input
                v-model="phoneNume"
                placeholder="Enter your mobile number"
                class="input-with-select"
...
<!--              </template>-->
          ...
          <div style="width: 100%;margin-top: 20px;  text-align: center; color: #71717A; font-size: 12px; font-weight: normal; font-weight: 400; line-height: 16px; word-wrap: break-word">We will send you a one-time verification code through SMS.</div>

          <div @click="sendSms2(1)" style="cursor: pointer; width: 100%;margin-top: 20px;  height: 100%; padding-top: 15px; padding-bottom: 15px; background: #F43F5E; border-radius: 12px; justify-content: center; align-items: center; display: inline-flex">
            <div style="text-align: center; color: white; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word">Send OTP</div>
          </div>
          <div style="display: inline-flex; margin-top: 50px; width: 100%; color: #71717A; font-size: 12px; font-weight: normal; font-weight: 400; line-height: 16px; word-wrap: break-word; align-items: center;">
      ...
      <el-drawer v-model="drawer2" :direction="direction" :append-to-body=true :visible="drawer" size="50%" title="I am the title" :with-header="false" :z-index=999 style="border-top-left-radius: 1.5rem; border-top-right-radius: 1.5rem" >
        <div style=" justify-content: center; align-items: center;">
          <div style="width: 100%; text-align: center; color: #09090B; font-size: 18px; font-weight: normal; font-weight: 600; line-height: 28px;margin-top: 20px; word-wrap: break-word">Enter the verification code</div>
          <div style="width: 100%; text-align: center; color: #71717A; font-size: 14px; font-weight: normal; font-weight: 400; line-height: 20px;margin-top: 20px; word-wrap: break-word">Enter the secret code we sent to +91{{phoneNume}}</div>
          <div style="flex-direction: column; justify-content: flex-start; align-items: center; gap: 12px; display: flex;margin-top: 20px;">
            <div class="digit-input-div" style=" border-radius: 21.82px; justify-content: center; align-items: center; gap: 8.18px; display: inline-flex">
              <input v-for="(digit, index) in digits" @keydown="onKeyDown(index, $event)"  pattern="[0-9]*" inputmode="numeric" :key="index" v-model="digits[index]" @input="onDigitInput(index)" maxlength="1" class="digit-input" />
            </div>
          </div>
          <div style="width: 100%; text-align: center;margin-top: 20px;"><span style="color: #71717A; font-size: 14px; font-weight: normal; font-weight: 500; line-height: 20px; word-wrap: break-word">Haven't received your code? </span><span @click="reSendMsg" style="cursor: pointer; color: #F43F5E; font-size: 14px; font-weight: normal; font-weight: 600; line-height: 20px; word-wrap: break-word">Resend OTP</span></div>
          <div style="width: 100%; padding-top: 15px;margin-top: 20px; padding-bottom: 15px; background: #F43F5E; border-radius: 12px; justify-content: center; align-items: center; display: inline-flex">
            <div style="text-align: center; color: white; font-size: 16px; font-weight: normal; font-weight: 700; line-height: 24px; word-wrap: break-word">Verify</div>
          </div>
        </div>
      </el-drawer>
...
const navList = [
  ...
  { label: "Voice", to: "/voice.html", toList: ["/voice.html"] },
  { label: "About Us", to: "/about.html", toList: ["/about.html"] },
  { label: "Compliance", to: "/compliance.html", toList: ["/compliance.html","/terms.html","/cancellation.html","/disclaimer.html","/purchase.html"] },
];
