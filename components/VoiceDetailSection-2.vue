...
<template>
  <section class="section">
    ...
    <section class="hidden lg:flex lg">
      <div class="mx-auto flex max-w-7xl items-center justify-between py-2 px-4 lg:p-6 lg:px-4" style="width: 100%; height: 100%;padding-top:50px;  flex-direction: column;  gap: 32px; display: inline-flex">
        <div style="align-self: stretch; justify-content: space-between; align-items: center; display: inline-flex">
          <div style="color: black; font-size: 36px; font-family: Amiri; font-weight: 700; line-height: 36px; word-wrap: break-word">Voice Streaming</div>
        </div>
      </div>
    </section>
  ...
  <section class="section">
    ...
    <section class="hidden lg:flex lg">
      <div class="mx-auto flex max-w-7xl items-center justify-between " style="  flex-direction: column;  gap: 48px; display: grid; grid-template-columns: repeat(2, 1fr);">
            ...
            <div style="align-self: stretch; height: 87px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 11px; display: flex">
              <div style="align-self: stretch; justify-content: space-between; align-items: center; display: inline-flex">
                <div style="justify-content: flex-start; align-items: center; gap: 10px; display: flex">
                  <div style="color: #09090B; font-size: 20px; font-weight: normal; font-weight: 700; line-height: 28px; word-wrap: break-word">{{slide.title}}</div>
...
<!--                    <div style="width: 20px; height: 20px; left: 2px; top: 2px; position: absolute; border-radius: 9999px; border: 1.50px #E8E8E8 solid"></div>-->
              ...
              <div style="align-self: stretch; color: #71717A; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word" @click="toDetail(slide.roomId)">{{slide.announcement}}</div>
            </div>
