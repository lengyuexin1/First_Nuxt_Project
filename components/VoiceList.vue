...
<template>
  ...
  <section class="section">
    ...
    <section class=" lg:hidden md header-tag">
      <div class="lg:p-6 lg:px-4 py-2 px-4 items-center flex max-w-7xl header-tag"
           style="width: 100%; height: 100%; padding-top: 16px;position:relative; padding-bottom: 16px;">
        <div
            style="justify-content: center;flex-direction: column; align-items: center; gap: 4px; display: flex;position:absolute;top: -27vw;left:23%;z-index:1;">
          <div class="top-tips">Super popular and interesting room</div>
          <div class="top-title">Voice Chat Room</div>
        </div>
      </div>
  ...
  section {
    ...
    &.md {
      .top-tips {
        ...
        font-style: normal;
        font-weight: 600;
        line-height: 8.739px; /* 87.392% */
        letter-spacing: 0.328px;
        text-transform: uppercase;
        padding: 2.1vw 2.1vw;
        border-radius: 24.033px;
        border: 0.546px solid #050505;
        background: #F6CBE4;
      }
      ...
      & > div {
        ...
        .info-box {
          ...
          min-height: 218px;
          max-height: 350px;
          background: linear-gradient(102deg, #f7faff 0%, #f5f9ff 100%);
          box-shadow: 0px 0px 8px 0px rgba(189, 214, 255, 0.23);
        ...
        .center-div {
          ...
          & > div {
            ...
            & > div {
              ...
              width: 100%;
              height: 100%;
              box-shadow: 0px 0px 12px 9px rgba(189, 214, 255, 0.23);
              border-radius: 4px;
