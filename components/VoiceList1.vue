...
<template>
  ...
  <section class="section">
    ...
    <section class="hidden lg:flex lg">
      <div  v-if="dataCount" class="mx-auto flex max-w-7xl items-center justify-between " style="  flex-direction: column;  gap: 48px; display: grid; grid-template-columns: repeat(2, 1fr);">
        <div   v-for="(slide, idx) in dataInfo"  style="width:628px;height: 200px;cursor: pointer; padding: 20px; background: #FAF6F3; border-radius: 12px; justify-content: flex-start; align-items: flex-start; gap: 20px; display: flex" @click="toDetail(slide.roomId)">
      ...
      <div v-if="!dataCount" class="mx-auto flex max-w-7xl items-center justify-between "  style="flex-direction: column; justify-content: flex-start; align-items: center; gap: 24px; display: flex">
    ...
    <section class="p-3 lg:hidden md">
      <div class="container">
        <div style="width: 100%; color: #101828; font-size: 18px; font-weight: normal; font-weight: 500; line-height: 28px; word-wrap: break-word">Voice Room</div>
