...
import image1 from "@/assets/images/about_banner.jpg";
  ...
  section {
    &.lg {
      ...
      .boxthree-left {
        ...
        .boxthree-btn {
          margin-top: 15px;
          color: var(--color-text-icon-color-1, #09090B);
          font-family: Inter;
          font-size: 24px;
          font-style: normal;
          font-weight: 500;
      ...
      .swiper-bottom {
        ...
        .swiper-centent {
          ...
          .swiper-tips {
            display: flex;
            padding: 7px var(--Color-card-2, 12px);
            justify-content: center;
            align-items: center;
            gap: 10px;
            border-radius: 44px;
          ...
          .swiper-btn {
            ...
            width: 160px;
            height: 50px;
            padding: 12.5px 36.677px 13.5px 37px;
            justify-content: center;
            align-items: center;
            flex-shrink: 0;
            border-radius: 4px;
