        ...
        <div
          ...
          <div v-cloak class="chat-content"
            ...
            <div class="avatar-row"
                 style="display: flex;justify-content: center;align-items: center;width:646px;">
              <!--              <div>-->
              ...
              <div
                ...
                <div
                    style="width: 73.53px; height: 73.53px;  position: relative;border-radius: 12px;border: 2px #050505 solid;overflow: hidden;box-shadow: 0 2.2px 0 0 #050505">
                  <div
                      style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img
              ...
              <div v-else
                   style="width: 110px; height: 134px; flex-direction: column; justify-content: space-between; align-items: center; display: inline-flex">
                <div
                  ...
                  <img style="width: 35.29px; height: 35.29px; margin: 0 auto;" alt="voice_desk"
                       :src="voice_desk"/>
                </div>
                <div
                          ...
                          <div style="overflow: hidden;align-items: center;justify-content: center;">
                              <span v-for="(slide1, idx1) in slide" @click="activeGift1(idx1,slide1.goodsDto)"
                                ...
                                <div :class="{'active1': currentItem1 === idx1, 'no_active1': currentItem1 != idx1}"
                                  ...
                                  <p style="width: 81px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis; color: var(--color-text-icon-color-1, #09090B);text-align: center;/* text-xs/semibold */font-family: var(--font, Archivo);font-size: 12px;font-style: normal;font-weight: 600;line-height: 16px; /* 133.333% */">{{
    ...
    <section class="lg:hidden md" style="height: 100%">
      <div :style="{ backgroundImage: 'url(' + icon11 + ')' }">
        <div style="width: 100%; height: 100%; margin-top:10%">
          <div
              style="padding: 2px; left: 12px; top: 7px; position: absolute; border-top-left-radius: 30px; border-top-right-radius: 30px; justify-content: flex-start; align-items: center; gap: 11px; display: inline-flex">
            <div style="justify-content: flex-start; align-items: flex-start; gap: 6px; display: flex">
              ...
              <div
                ...
                <div style="justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
                  <div
                      style="color: rgba(255, 255, 255, 0.83); font-size: 14px; font-family: Figtree; font-weight: 600; max-width: 60%; word-wrap: break-word; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    {{ dataInfo.title }}
                  </div>
                  <div
                ...
                <div
                    style="color: rgba(255, 255, 255, 0.60); font-size: 10px;white-space: nowrap;  font-family: Figtree; font-weight: 500; max-width: 70%; word-wrap: break-word;overflow: hidden;text-overflow: ellipsis;">
                  {{ dataInfo.announcement }}
                </div>
              </div>
            </div>
                ...
                <div v-if="userList[0]"
                  ...
                  <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                    <div style="width: 68px; height: 68px; position: relative">
                      <div
                          style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                      <img
                          style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px"
                          :src="userList[0].avatarUrl"/>
                      <div
                          style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                        <div
                            style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                      </div>
                    ...
                    <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                      <div
                          style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">
                        {{ userList[0].userName }}
                      </div>
                    </div>
                  </div>
                ...
                <div v-else
                  ...
                  <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                    <div style="width: 68px; height: 68px; position: relative; border-radius: 50px">
                      <div
                          style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                      <div
                        ...
                        <div style="width: 24px; height: 24px; position: relative; opacity: 0.50">
                          <img style="width: 20px; height: 18.10px; left: 2px; top: 3px; position: absolute"
                               :src="voice_desk"/>
                        </div>
                      </div>
                    </div>
        ...
        <div
            style="width: 100%; height: 100%; bottom:0%;position:absolute;top: 60%;left: 16px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
      ...
      <el-drawer v-model="drawer" :direction="direction" :append-to-body=true :visible="drawer" size="50%"
                 ...
                 style="border-top-left-radius: 1.5rem; border-top-right-radius: 1.5rem;background-color: #232136;">
        <div style="position: sticky;top:0;z-index: 999;background: #232136;width: 100%">
          <div
              style="color: #FAFAFA;padding-top:12px;margin-left:15px; font-size: 18px; font-weight: normal; font-weight: 700; line-height: 28px; word-wrap: break-word">
            Gift
          </div>
        </div>
            ...
            <div
              ...
              <span v-for="(slide1, idx1) in slide" @click="activeGift1(idx1,slide1.goodsDto)"
                ...
                <div style="display: flex;align-items: center;flex-direction: column;">
                  ...
                  <p style="width: 50px; text-align: center; color: white;  overflow: hidden; font-size: 12px; font-family: Figtree; font-weight: 300;color: #FFFFFF; word-wrap: break-word;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">{{
                      slide1.goodsDto.title
                    }}</p>
                  <p style="display: flex;align-items: center;">
                    <span>
        ...
        <div
            style="width: 100%;position:sticky; bottom: 0;z-index:999;background:#232136;height: 56px; justify-content: space-between; align-items: center; display: inline-flex">
          <div
            ...
            <div style="justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
              <div style="justify-content: flex-start; align-items: center; gap: 4px; display: flex">
                ...
                <div
                    style="color: #FAFAFA; font-size: 14px; font-family: Mulish; font-weight: 600; word-wrap: break-word">
                  {{ gold }}
                </div>
              </div>
              <div style="justify-content: flex-start; align-items: center; display: flex">
