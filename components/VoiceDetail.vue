...
const popperStyle = ref("border-radius: 20px; background-color: #232136;")
</script>
<template>
...
<!--      <button @click="play">123333</button>-->
      <div class="mx-auto flex max-w-7xl items-center justify-between py-2 px-4 lg:p-6 lg:px-4" style="width: 100%; height: 100%;  justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
<!--        <button @click="addMsg">addMsg</button>-->
        <div style="border-radius: 12px; position: relative; overflow: hidden; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">

          <div style="width: 926px; height: 60px; position: relative; background: white">
            <div style="left: 64px; top: 35px; position: absolute; color: #71717A; font-size: 10px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{dataInfo.announcement}}</div>
            <div style="left: 64px; top: 14px; position: absolute; justify-content: flex-start; align-items: center; gap: 9px; display: inline-flex">
              <div style="color: #09090B; font-size: 16px; font-family: Figtree; font-weight: 600; word-wrap: break-word">{{dataInfo.title}}</div>
              <div style="padding-left: 5.33px; padding-right: 5.33px; padding-top: 1px; padding-bottom: 1.33px; border-radius: 6666px; justify-content: flex-start; align-items: center; gap: 1.33px; display: flex">
                <div style="width: 100%; position: relative">
                  <img style="width: 41.6px;height: 16.6px;" :src="icon1" />
                </div>
              </div>
            </div>
            <div style="width: 40px; height: 40px; left: 15px; top: 10px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
...
<!--            </div>-->
          ...
          <div v-cloak class="chat-content" :style="{ backgroundImage: 'url(' + icon3 + ')' }">
            <div class="avatar-row">
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[0]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[0].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[0].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                  <div style="padding: 19.12px; left: 13.24px; top: 13.24px; position: absolute; justify-content: flex-start; align-items: flex-start; gap: 11.76px; display: inline-flex">
                    <div style="width: 35.29px; height: 35.29px; position: relative; opacity: 0.50">
                      <img style="width: 29.41px; height: 26.61px; left: 2.94px; top: 4.41px; position: absolute" :src="voice_desk" />
                    </div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.1</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[1]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[1].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[1].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.2</div>
              </div>
            </div>
            <div class="avatar-row">
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[2]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[2].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[2].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.3</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[3]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[3].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[3].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.4</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[4]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[4].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[4].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.5</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[5]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[5].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[5].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.6</div>
              </div>
            </div>
            <div class="avatar-row">
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[6]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[6].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[6].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.7</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[7]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[7].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[7].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.8</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[8]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[8].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[8].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.9</div>
              </div>
              <div style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex" v-if="userList[9]">
                <div style="width: 100px; height: 100px; position: relative">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                  <img style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; border-radius: 9999px; border: 2px rgba(255, 255, 255, 0.50) solid" :src="userList[9].avatarUrl" />
                  <div style="width: 73.53px; height: 73.53px; padding: 25px; left: 13.24px; top: 13.24px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                    <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                  </div>
                </div>
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">{{userList[9].userName}}</div>
              </div>
              <div v-else style="width: 100%; height: 100%; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="width: 100px; height: 100px; position: relative; border-radius: 73.53px">
                  <div style="width: 73.53px; height: 73.53px; left: 13.24px; top: 13.24px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                ...
                <div style="color: white; font-size: 16px; font-weight: normal; font-weight: 500; line-height: 24px; word-wrap: break-word">&nbsp;No.10</div>
              </div>
            </div>
          </div>
              ...
              <div class="enter-content">
                <div class="enter-left-content">
                  ...
                  <div class="enter-text-content">
                    <div style="color: white; font-size: 9.89px; font-family: Figtree; font-weight: 600; word-wrap: break-word; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{slide.nickName}}</div>
                    <div style="color: white; font-size: 13.19px; font-family: Figtree; font-weight: 700; word-wrap: break-word">{{slide.type}}</div>
                  </div>
                </div>
                <img v-if="slide.giftImg" style="width: 39px; height: 39px;" :src="slide.giftImg" />
                <div style="color: #FFD41A; font-size: 18.66px; font-family: Mulish; font-style: italic; font-weight: 700; margin-right: 5px;word-wrap: break-word">×{{slide.num}}</div>
              </div>
            </div>
          </div>
          ...
          <div style="width: 926px; height: 110px;margin-right: 70px; padding-top: 30px; padding-bottom: 8px; padding-left: 290px; padding-right: 8px; background: white; justify-content: flex-end; align-items: center; display: inline-flex">
            <div style="justify-content: flex-start; align-items: flex-start;  display: inline-flex;margin-right: 8px;margin-left: 8px">
                ...
                <div style="width: 70px;height: 62px; padding-left: 2px; padding-right: 2px;   background: #FAFAFA; border-radius: 6px; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                  <ClientOnly>
                    <el-popover
                        ...
                        style="border-radius: 20px; background-color: #232136;"
                    >
                      <p><div style="color: #FAFAFA; font-size: 18px; font-weight: normal; font-weight: 700; line-height: 28px; word-wrap: break-word">Gift</div></p>
                      <el-carousel height="auto" :autoplay="autoplay">
                        <el-carousel-item v-for="(slide, idx) in giftInfo"  style="height: 250px;margin-left: 30px;">
                          <div style="overflow: hidden;align-items: center;justify-content: center;">
                              <span v-for="(slide1, idx1) in slide" @click="activeGift1(idx1,slide1.goodsDto)"   style="cursor: pointer; width: 81px; margin: 10px; height: 96px; float: left; ">
                                <div :class="{'active1': currentItem1 === idx1, 'no_active1': currentItem1 != idx1}" style="display: flex;flex-direction: column;align-items: center;">
                                  <img style="width: 60px; height: 60px; " :src="slide1.goodsDto.url" />
                                  <p style="text-align: center;width: 81px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{slide1.goodsDto.title}}</p>
                                  <p style="display: flex;align-items: center;">
                                    <span>
                                      <img style="width: 9px; height: 9px;" :src="icon7" />
                                    </span>
                                    <span>{{slide1.goodsDto.price}}</span>
                                  </p>
                                </div>
                              </span>
                          </div>
                      ...
                      <div style="width: 100%; height: 100%; padding: 12px; justify-content: space-between; align-items: center; display: inline-flex">
                        <div style="padding-top: 7px; padding-bottom: 7px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
                          <div style="justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
                            <div style="justify-content: flex-start; align-items: center; gap: 4px; display: flex">
                              ...
                              <div style="color: #FAFAFA; font-size: 14px; font-family: Mulish; font-weight: 600; word-wrap: break-word">{{gold}}</div>
                            </div>
                            <div style="justify-content: flex-start; align-items: center; display: flex">
                              <nuxt-link to="/recharge.html"><div style="color: #F59E0B; font-size: 14px; font-family: Mulish; font-weight: 600; word-wrap: break-word">Recharge</div></nuxt-link>
                              <div style="width: 16px; height: 16px; position: relative;">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M5.33366 13.3335L10.667 8.00016L5.33366 2.66683" stroke="#F59E0B" stroke-width="1.33333" stroke-linecap="square"/>
                                </svg>
                              </div>
                            </div>
                          </div>
                      ...
                      <template #reference>
                        <button>
                          <div style="width: 40px; height: 40px; position: relative">
                            ...
                            <img style="width: 46.67px; height: 44px; left: -3.33px; top: -5px; position: absolute" :src="icon5" />
                          </div>
                          <div style="justify-content: flex-start; align-items: center; display: inline-flex">
                            <div style="text-align: center; color: #71717A; font-size: 12px; font-family: Figtree; font-weight: 400; word-wrap: break-word">More</div>
                  ...
                  <div class="enter-the-room" :style="{ left: -(idx * 20) + 'px' }" v-for="(slide,idx) in enterRoomInfo2">
                    <div class="enter-content">
                      <div class="enter-left-content">
                        <img style="width: 33px; height: 33px; border-radius: 9999px" :src="slide.headImg" />
                        <div class="enter-text-content">
                          <div style="color: white; font-size: 9.89px; font-family: Figtree; font-weight: 600; word-wrap: break-word">{{slide.nickName}}</div>
                          <div style="color: white; font-size: 13.19px; font-family: Figtree; font-weight: 700; word-wrap: break-word">{{slide.type}}</div>
                        </div>
                      </div>
                      <img v-if="slide.giftImg" style="width: 39px; height: 39px; " :src="slide.giftImg" />
                      <div style="color: #FFD41A; font-size: 18.66px; font-family: Mulish; font-style: italic; font-weight: 700; word-wrap: break-word;margin-right: 5px;">×{{slide.num}}</div>
                    </div>
                  </div>
                </div>
              ...
              <nuxt-link to="/recharge.html">
                <div style="width: 90px; padding-left: 2px; padding-right: 2px; padding-top: 4px; padding-bottom: 4px; background: #F59E0B; border-radius: 6px; flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">

                  <div style="width: 40px; height: 40px; padding: 1.67px; justify-content: center; align-items: center; display: inline-flex">
                    <nuxt-link to="/recharge.html"><img style="width: 36.67px; height: 36.67px" :src="icon7" /></nuxt-link>
                  </div>
                  <div style="justify-content: flex-start; align-items: center; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 400; word-wrap: break-word">Recharge</div>
                    <div style="width: 14px; height: 14px; position: relative">
                      <img style="width: 14px; height: 14px;" :src="icon8">
                    </div>
                  </div>
        ...
        <div style="width: 330px; align-self: stretch; background: white; border-radius: 12px; overflow: hidden; flex-direction: column; justify-content: space-between; align-items: flex-start; display: inline-flex">
          <div style="align-self: stretch; padding: 12px; border-bottom: 1px #F4F4F5 solid; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
            <div style="justify-content: flex-start; align-items: center; gap: 2px; display: flex">
              ...
              <div style="color: #09090B; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">Online User:</div>
              <div style="color: #09090B; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userTotalCount}}</div>
            </div>
          </div>
          <div style="align-self: stretch; flex: 1 1 0; padding-left: 12px; padding-right: 12px; padding-top: 8px; padding-bottom: 8px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 16px; display: flex">
            <div style="align-self: stretch; justify-content: flex-start; align-items: flex-start; gap: 4px; display: inline-flex">
              <div style="flex: 1 1 0; color: #F59E0B; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{dataInfo.announcement}}</div>
            </div>
            <div ref="chatMsgRef" id="chatMsg" style=" height: 400px;overflow-y: auto;border: 0px solid #ccc;padding: 10px;" >
              <div v-for="(slide,id) in chatMsgInfo" style="align-self: stretch; justify-content: flex-start; align-items: flex-start; gap: 4px; display: inline-flex">
                <div style="justify-content: flex-start; align-items: flex-start; gap: 2px; display: flex">
                  <div style="color: #3B82F6; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word;word-wrap: break-word; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{slide.userName}}</div>
                  <div style="color: #3B82F6; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">:</div>
                </div>
                <div v-if="slide.content=='Enter the room'" style="width: 224px; color: #F59E0B; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{slide.content}}</div>
                <div v-else style="width: 224px; color: #3F3F46; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{slide.content}}</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="lg:hidden md" style="height: 100%">
      <div  :style="{ backgroundImage: 'url(' + icon11 + ')' }">
        <div style="width: 100%; height: 100%; margin-top:10%">
          <div style="padding: 2px; left: 12px; top: 7px; position: absolute; border-top-left-radius: 30px; border-top-right-radius: 30px; justify-content: flex-start; align-items: center; gap: 11px; display: inline-flex">
            <div style="justify-content: flex-start; align-items: flex-start; gap: 6px; display: flex">
              <div style="width: 30px; height: 30px; justify-content: center; align-items: center; display: flex">
                <img style="width: 30px; height: 30px; border-radius: 15px" :src="dataInfo.avatarUrl" />
              </div>
              <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
                <div style="justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
                  <div style="color: rgba(255, 255, 255, 0.83); font-size: 14px; font-family: Figtree; font-weight: 600; max-width: 60%; word-wrap: break-word; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    {{ dataInfo.title }}
                  </div>
                  <div style="padding-left: 4.26px; padding-right: 4.26px; padding-top: 1.07px; padding-bottom: 1.07px;  border-radius: 5328.82px; justify-content: flex-start; align-items: center; gap: 1.07px; display: flex">
                    <img style="width: 33.12px; height: 13.13px;" :src="icon1">
                  </div>
                </div>
                <div style="color: rgba(255, 255, 255, 0.60); font-size: 10px;white-space: nowrap;  font-family: Figtree; font-weight: 500; max-width: 70%; word-wrap: break-word;overflow: hidden;text-overflow: ellipsis;">{{dataInfo.announcement}}</div>
              </div>
            </div>
          </div>
          <div v-cloak class="chat-content">
            <div class="avatar-row">
              ...
              <div style="width: 100%; height: 100%; justify-content: center; align-items: flex-start; gap: 21px; display: inline-flex">
                <div v-if="userList[0]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                  <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                    <div style="width: 68px; height: 68px; position: relative">
                      <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                      <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[0].avatarUrl" />
                      <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                        <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                      </div>
                      <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                    </div>
                    <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                      <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[0].userName}}</div>
                    </div>
                  </div>
                </div>
                <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                  <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                    <div style="width: 68px; height: 68px; position: relative; border-radius: 50px">
                      <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: rgba(255, 255, 255, 0.20); border-radius: 9999px"></div>
                      <div style="padding: 13px; left: 9px; top: 9px; position: absolute; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
                        <div style="width: 24px; height: 24px; position: relative; opacity: 0.50">
                          <img style="width: 20px; height: 18.10px; left: 2px; top: 3px; position: absolute" :src="voice_desk" />
                        </div>
                      </div>
                    </div>
                    <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                      <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.1</div>
                    </div>
                  </div>
                </div>
                <div v-if="userList[1]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                  <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                    <div style="width: 68px; height: 68px; position: relative">
                      <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                      <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[1].avatarUrl" />
                      <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                        <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                      </div>
                      <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                    ...
                    <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                      <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[1].userName}}</div>
                    </div>
                  </div>
                </div>
                <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                  <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                    ...
                    <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                      <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.2</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="avatar-row">
              <div v-if="userList[2]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[2].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[2].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.3</div>
                  </div>
                </div>
              </div>
              <div v-if="userList[3]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[3].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[3].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">No.4&nbsp;</div>
                  </div>
                </div>
              </div>
              <div v-if="userList[4]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[4].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[4].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">No.5&nbsp;</div>
                  </div>
                </div>
              </div>
              <div v-if="userList[5]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[5].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[5].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.6</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="avatar-row">
              <div v-if="userList[6]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[6].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[6].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">No.7&nbsp;</div>
                  </div>
                </div>
              </div>
              <div v-if="userList[7]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[7].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[7].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.8</div>
                  </div>
                </div>
              </div>
              <div v-if="userList[8]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[8].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[8].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.9</div>
                  </div>
                </div>
              </div>
              <div v-if="userList[9]" style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  <div style="width: 68px; height: 68px; position: relative">
                    <div style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: #C4C4C4; border-radius: 9999px"></div>
                    <img style="width: 50px; height: 50px; left: 9px; top: 9px; position: absolute; background: linear-gradient(0deg, white 0%, white 100%); border-radius: 9999px" :src="userList[9].avatarUrl" />
                    <div style="width: 50px; height: 50px; padding: 17px; left: 9px; top: 9px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
                      <div style="flex: 1 1 0; align-self: stretch; justify-content: center; align-items: center; display: inline-flex"></div>
                    </div>
                    <div style="width: 68px; height: 68px; left: 0px; top: 0px; position: absolute"></div>
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{userList[9].userName}}</div>
                  </div>
                </div>
              </div>
              <div v-else style="flex-direction: column; justify-content: flex-start; align-items: center; display: inline-flex">
                <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                  ...
                  <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                    <div style="text-align: center; color: white; font-size: 12px; font-family: Figtree; font-weight: 500; word-wrap: break-word">&nbsp;No.10</div>
                  </div>
                </div>
              </div>
            </div>
         ...
         <nuxt-link to="/">
           <div  style="left: 90%; top: 0;width: 40px;height: 40px;z-index: 999; position: absolute; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
          ...
          <div style="padding-left: 8px; padding-right: 8px; padding-top: 4px; padding-bottom: 4px; left: 75%; top: 9px; position: absolute; background: rgba(255, 255, 255, 0.10); border-radius: 23px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex">
            <div style="justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
              <div style="width: 16px; height: 16px; position: relative">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.61342 8.47562C1.52262 8.33186 1.47723 8.25998 1.45182 8.14911C1.43273 8.06583 1.43273 7.9345 1.45182 7.85122C1.47723 7.74035 1.52262 7.66847 1.61341 7.52471C2.36369 6.33672 4.59693 3.3335 8.00027 3.3335C11.4036 3.3335 13.6369 6.33672 14.3871 7.52471C14.4779 7.66847 14.5233 7.74035 14.5487 7.85122C14.5678 7.9345 14.5678 8.06583 14.5487 8.14911C14.5233 8.25998 14.4779 8.33186 14.3871 8.47562C13.6369 9.6636 11.4036 12.6668 8.00027 12.6668C4.59693 12.6668 2.36369 9.6636 1.61342 8.47562Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8.00027 10.0002C9.10484 10.0002 10.0003 9.10473 10.0003 8.00016C10.0003 6.89559 9.10484 6.00016 8.00027 6.00016C6.8957 6.00016 6.00027 6.89559 6.00027 8.00016C6.00027 9.10473 6.8957 10.0002 8.00027 10.0002Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <div style="text-align: right; color: white; font-size: 12px; font-weight: normal; font-weight: 500; line-height: 16px; word-wrap: break-word">{{userTotalCount}}</div>
            </div>
          </div>
        </div>

        <div style="width: 100%; height: 100%; bottom:0%;position:absolute;top: 60%;left: 16px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
          <div style="justify-content: flex-start; align-items: flex-start; gap: 4px; display: inline-flex">
            <div style="width: 224px; color: #FBBF24; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{dataInfo.announcement}}</div>
          </div>
          <div ref="chatMsgRef" id="chatMsg1" style=" height: 200px;overflow-y: auto;border: 0px solid #ccc;padding: 10px;" >
            <div v-for="(slide,id) in chatMsgInfo" style="align-self: stretch; justify-content: flex-start; align-items: flex-start; gap: 4px; display: inline-flex">
              <div style="justify-content: flex-start; align-items: flex-start; gap: 2px; display: flex">
                <div style="color: rgba(255, 255, 255, 0.70); font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{slide.userName}}</div>
                <div style="color: rgba(255, 255, 255, 0.70); font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">:</div>
              </div>
              <div v-if="slide.content=='Enter the room'" style="width: 200px; color: #F59E0B; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{slide.content}}</div>
              <div v-else style="width: 200px; color: white; font-size: 14px; font-family: Figtree; font-weight: 500; word-wrap: break-word">{{slide.content}}</div>
            </div>
          </div>
        </div>
        <div v-if="!voicePlay" @click="play" style="cursor: pointer; position: fixed;left: 70%;top:85%;">
          <svg width="97" height="32" viewBox="0 0 97 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="97" height="32" rx="16" fill="white" fill-opacity="0.1"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M28.153 10.4624C28.5042 10.3039 28.9174 10.4602 29.0759 10.8114C29.5103 11.7743 30 13.3863 30 15.7495C30 17.7881 29.6356 19.2684 29.2558 20.2557C29.0663 20.7485 28.8738 21.1161 28.7233 21.3671C28.648 21.4926 28.5833 21.5888 28.5347 21.6568C28.5104 21.6908 28.4901 21.7178 28.4746 21.7378C28.4668 21.7479 28.4602 21.7562 28.4549 21.7628L28.448 21.7714L28.4452 21.7748L28.444 21.7762C28.444 21.7762 28.4429 21.7775 27.907 21.3308L28.4429 21.7775C28.1963 22.0735 27.7563 22.1135 27.4603 21.8668C27.1658 21.6213 27.1247 21.1845 27.3675 20.8885C27.3675 20.8885 27.3691 20.8864 27.3707 20.8843C27.3756 20.878 27.3854 20.8652 27.3992 20.8458C27.4269 20.807 27.4712 20.7418 27.5267 20.6492C27.6378 20.4642 27.7942 20.169 27.9535 19.7548C28.2714 18.9282 28.6047 17.6178 28.6047 15.7495C28.6047 13.5854 28.1576 12.169 27.804 11.3853C27.6455 11.034 27.8018 10.6209 28.153 10.4624Z" fill="white"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M26.1991 13.2059C26.5763 13.1276 26.9457 13.3699 27.024 13.7472C27.1265 14.2406 27.2093 14.902 27.2093 15.7495C27.2093 16.7821 27.0863 17.5381 26.9549 18.0506C26.8892 18.3067 26.8217 18.501 26.767 18.6379C26.7396 18.7063 26.7155 18.7603 26.6964 18.8003C26.6869 18.8203 26.6786 18.8368 26.6719 18.8499L26.6629 18.867L26.6593 18.8736L26.6578 18.8765L26.6571 18.8778C26.6571 18.8778 26.6564 18.879 26.0465 18.5402L26.6564 18.879C26.4693 19.2158 26.0445 19.3372 25.7077 19.15C25.3737 18.9645 25.2516 18.5454 25.4319 18.2099L25.4366 18.2004C25.443 18.187 25.4552 18.1603 25.4714 18.1197C25.5039 18.0386 25.5526 17.9015 25.6033 17.7041C25.7044 17.3096 25.814 16.6703 25.814 15.7495C25.814 14.9934 25.7401 14.4273 25.6578 14.0308C25.5795 13.6535 25.8218 13.2842 26.1991 13.2059Z" fill="white"/>
            <path d="M29.3305 7.87069C29.603 7.59823 29.603 7.15649 29.3305 6.88403C29.0581 6.61157 28.6163 6.61157 28.3439 6.88403L24.2051 11.0228C24.1624 10.5358 24.1066 10.1048 24.0251 9.73064C23.8653 8.99722 23.5817 8.35951 22.9869 7.94151C22.7683 7.78785 22.5248 7.66396 22.2719 7.57765C21.5108 7.31792 20.7543 7.52553 19.9859 7.89881C19.2291 8.26644 18.3108 8.8719 17.1658 9.62687L16.9177 9.79049C16.501 10.0652 16.3577 10.157 16.2094 10.2225C16.0507 10.2925 15.8839 10.3425 15.7129 10.3714C15.5531 10.3984 15.3829 10.4006 14.8838 10.4006L14.734 10.4006C13.602 10.4 12.8154 10.3996 12.1162 10.7231C11.4699 11.0221 10.8478 11.6074 10.51 12.2344C10.1448 12.9122 10.1019 13.6211 10.041 14.629L10.0337 14.7504C10.0128 15.093 10 15.4317 10 15.7495C10 16.0672 10.0128 16.406 10.0337 16.7486L10.041 16.8699C10.1019 17.8779 10.1448 18.5868 10.51 19.2646C10.8478 19.8915 11.4699 20.4769 12.1162 20.7759C12.6842 21.0387 13.3098 21.0877 14.1314 21.0965L11.5997 23.6282C11.3272 23.9007 11.3272 24.3424 11.5997 24.6149C11.8722 24.8873 12.3139 24.8873 12.5864 24.6149L29.3305 7.87069Z" fill="white"/>
        ...
        <div class="gift-info2">
          ...
          <div class="box" style="background-color: #F59E0B">
            ...
            <p><nuxt-link to="/recharge.html">Recharge ></nuxt-link></p>
          </div>
        </div>
      </div>
      <el-drawer v-model="drawer" :direction="direction" :append-to-body=true :visible="drawer" size="50%" title="I am the title" :with-header="false" :z-index=999 style="border-top-left-radius: 1.5rem; border-top-right-radius: 1.5rem;background-color: #232136;" >
        <div style="position: sticky;top:0;z-index: 999;background: #232136;width: 100%">
          <div style="color: #FAFAFA;padding-top:12px;margin-left:15px; font-size: 18px; font-weight: normal; font-weight: 700; line-height: 28px; word-wrap: break-word">Gift</div>
        </div>
        ...
        >
          ...
          <SwiperSlide v-for="(slide, idx) in giftInfoH5" :key="idx" class="h-full" >
            <div style=" overflow-y: auto;align-items: center;justify-content: center;display: grid; grid-template-columns: repeat(4, 1fr);">
              <span v-for="(slide1, idx1) in slide" @click="activeGift1(idx1,slide1.goodsDto)" :class="{'active1': currentItem1 === idx1, 'no_active1': currentItem1 != idx1}"  style="cursor: pointer;  height: 90px; float: left; ">
                <div style="display: flex;align-items: center;flex-direction: column;">
                  <img style="width: 40px; height: 40px; " :src="slide1.goodsDto.url" />
                  <p style="width: 50px; text-align: center; color: white;  overflow: hidden; font-size: 12px; font-family: Figtree; font-weight: 300;color: #FFFFFF; word-wrap: break-word;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">{{slide1.goodsDto.title}}</p>
                  <p style="display: flex;align-items: center;">
                    <span>
                      <img style="width: 9px; height: 9px;" :src="icon7" />
                    </span>
                    <span style="color: #FFFFFF;font-size:10px;font-weight: 300;">{{slide1.goodsDto.price}}</span>
                  </p>
                </div>
              </span>
            </div>
        ...
        <div style="width: 100%;position:sticky; bottom: 0;z-index:999;background:#232136;height: 56px; justify-content: space-between; align-items: center; display: inline-flex">
          <div style="padding-top: 7px; margin-left: 8px;padding-bottom: 7px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: inline-flex">
            <div style="justify-content: flex-start; align-items: center; gap: 4px; display: inline-flex">
              <div style="justify-content: flex-start; align-items: center; gap: 4px; display: flex">
                <div style="width: 16px; height: 16px; position: relative">
                  <img style="width: 16px; height: 16px; left: 0px; top: 0px; position: absolute" :src="icon7" />
          ...
          <div @click="sendGift(currentItem1Info)" style="margin-right: 8px;">
  ...
  <ClientOnly>
    <el-dialog
        ...
        :width="dialogWidth"
        destroy-on-close
        :close-on-press-escape="passwordClose"
        :close-on-click-modal ="passwordClose"
      ...
      <div class="container">
        ...
        <div class="input-container">
          <div class="input-wrapper">
            <input v-for="(digit, index) in digits"  @keydown="onKeyDown(index, $event)" inputmode="numeric" pattern="[0-9]*" :key="index" v-model="digits[index]" @input="onDigitInput(index)" maxlength="1" class="digit-input" />
          </div>
        </div>
...
.container {
  ...
  @media (max-width: 768px) {
    .digit-input {
      flex: 0 0 calc(16.66% - 10px); /* 16.66% 代表平均分配宽度，减去右边距 10px */
    }
  }
  .header {
    width: 100%;
  ...
  .digit-input {
    flex: 1; /* 使用 flex 属性，使每个小方块平均占据可用空间 */
    width: 0; /* 必须设置为 0，以便 flex 属性生效 */
